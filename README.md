...
### Submission Notes (fill these in before submitting)

> **GitHub repository (public):** `REPLACE_WITH_PUBLIC_GITHUB_REPO_URL`
>
> **Frontend EKS Service URL:** `REPLACE_WITH_MP_FRONTEND_LB_URL`
>   - e.g. `http://ae0a1b2c...us-east-1.elb.amazonaws.com`
>   - Browser screenshot with this URL visible, showing the movie list.
>
> **Backend EKS Service URL:** `REPLACE_WITH_MP_BACKEND_LB_URL`
